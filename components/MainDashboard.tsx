      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between gap-2">
          <div>
            ...
            <p className="text-xs text-slate-400">
              Fix lead volume, weak funnel stages, or ACV gaps
              to understand the fastest route to target.
            </p>
          </div>
          {activeScenario && (
            <button
              ...
              <p className="text-xs text-slate-400">
                {leadVolumeIsUnderBenchmark ? (
                  <>
                    ...
                    for this period. See the impact of
                    bringing leads back to benchmark on ARR.
                  </>
                ) : weakestStage ? (
                  <>
